...
class Proprietario{
	...
	public function getPro_dti_cadastro() {
		return $this->pro_dti_cadastro;
	}

	public function setPro_dti_cadastro($pro_dti_cadastro) {
		$this->pro_dti_cadastro = $pro_dti_cadastro;
	}
